...
exports.run = (client, message, params) => {
  ...
  .setColor("#FFB900")
  .addField("**●İD● BOT • Komutlar**", `▫️ **|  id+eğlence:** Eğlence komutlarını gösterir. \n▫️ **|   id+moderasyon:** Moderasyon komutlarını gösterir. \n▫️ **|  id+anakomut:** Temel komutları gösterir. \n▫️ **|  id+resimefekt:** Resim Efektleri komutlarını gösterir \n▫️ **| id+atatürk-yardım:** Atatürk komutlarını gösterir \n▫️ **| id+gelen-gidenyardım Gelen-giden i yapmayı gösterir.`)
